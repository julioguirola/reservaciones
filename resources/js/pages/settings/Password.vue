...
<template>
    <AppLayout :breadcrumbs="breadcrumbItems">
        <Head title="Ajustes de conraseña" />

        <SettingsLayout>
            <div class="space-y-6">
                <HeadingSmall title="Actualizar contraseña" description="Asegura que tu cuenta está utilizando una contraseña larga y aleatoria" />
